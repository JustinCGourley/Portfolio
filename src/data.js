...
let textSources = {
  'transmission': {
    description: "This game was created durring Global Game Jam, a 42-hour game jam that I participated in with 4 people. We created a game that was based off 'Papers Please', in which you go through a series of days trying to accomplish a task each day. In this game, the task was decoding a message, and sending the answer through morse code. The objective of this game was to slowly teach the user morse code, as well as having a fun time learning it by solving various puzzles. The puzzles included finding hidden messages in given transmissions by using tools, and deductive reasoning to figure out what you needed to send.",
    coding: 'C# / Unity',
  ...
  'city': {
    description: 'This is a solo project I\'m currently working on. Right now it is a simple city builder being peiced together, which mainly allows me to mess around with coding things I find fun. Recently I\'ve been experimenting a lot with procedural generation, AI, and seeding',
    coding: "C# / Unity",
    contribution: '',
    link: '',
    linkTitle: '',
  ...
  'horde': {
    description: 'I worked in a group of 4 at a 42 hour game jam to create this zombie horde survival game. Fight waves of multiple types of zombies with your weapons that you collect from supply drops scattered throughout the map. From supply drops you can also find medical supplies and ammo for your weapons. You have to survive until all enemies in the wave are beaten to win!',
    coding: "C# / Monogame",
